            ...
            <div class="product-box-3 theme-bg-white h-100">
                <div class="product-header">
                    <div class="product-image">
                        <a href="#">
                            <img src="{{ asset('assets/images/product/6.png') }}" class="img-fluid blur-up lazyload" alt="">
                        </a>
        ...
        <div class="col-xxl-3 col-lg-6 col-md-4 col-sm-6">
            <div class="product-box-3 theme-bg-white h-100">
                <div class="product-header">
                    <div class="product-image">
                        <a href="#">
                            <img src="{{ asset('assets/images/product/2.png') }}" class="img-fluid lazyload" alt="">
                        </a>
                ...
                <div class="product-footer">
                    <div class="product-detail">
                        <span class="span-name">Hygiene</span>
                        <a href="#">
                            <h5 class="name">Prodct 2 name</h5>
                        </a>
