                ...
                window.table = $('table').DataTable({
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            orderable: false,
                            render: function(data, type, row) {
                                let editUrl = `{{ route('lab-tests.edit', ':id') }}`.replace(':id', row.id);
                                let deleteUrl = `{{ route('lab-tests.destroy', ':id') }}`.replace(':id', row.id);
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <button class="btn p-0 fs-6 delete-btn" data-source="lab test" data-endpoint="${deleteUrl}">
