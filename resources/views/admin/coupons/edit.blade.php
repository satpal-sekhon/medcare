                    ...
                    <form action="{{ route('coupons.update', [$coupon->id]) }}" method="post">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" name="code" placeholder="Coupon Code"
                                value="{{ old('code',  $coupon->code) }}" @class(['form-control', 'is-invalid'=>
                            $errors->first('code')]) maxlength="50">
                            @if ($errors->has('code'))
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-2">
                                    ...
                                    <input type="number" name="minimum_amount" placeholder="Minimum Order Amount" value="{{ old('minimum_amount',  $coupon->minimum_amount) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-2">
                                    ...
                                    <input type="number" name="limit_per_user" placeholder="Limit per user" value="{{ old('limit_per_user',  $coupon->limit_per_user) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-2">
                                    ...
                                    <select name="discount_type" @class(['form-control', 'is-invalid'=>
                                        $errors->first('discount_type')])>
                                        <option value="">Select Discount Type</option>
                                        <option value="amount" @selected(old('discount_type', $coupon->discount_type) ==
                                            'amount')>Amount</option>
                                        <option value="percentage" @selected(old('discount_type', $coupon->
                                            discount_type) == 'percentage')>Percentage</option>
                                    </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-2">
                                    ...
                                    <input type="text" name="expires_at" placeholder="Expires At"
                        ...
                        <div class="mb-3 mt-2 d-flex align-items-center gap-4">
                            ...
                            <label class="switch">
                                <input type="checkbox" name="is_active" value="1" @checked(old('is_active',
                                    $coupon->is_active==1))><span class="switch-state"></span>
                            </label>
                        </div>
